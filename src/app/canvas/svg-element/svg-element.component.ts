...
export class SvgElementComponent implements AfterViewInit{
  ...
  elements = [
    ...
    },
    {
      id: 'c1',
      polygon: {
        d:'m 1733.6289,2191.1445 -53.6289,78.5039 -162.0117,-111.0039 -65.8789,-44.875 -314.7735,-216.0078 54.0039,-78.5039 279.6446,191.5078 34.0039,23.75 65.5039,44.75 0.75,0.375 z m 0,0',
        cssClass: 'polygon'
      },
      rectangle: {
        x: 1457.8,
